...
const OfisGerecleri = () => {
  ...
  return (
    <div>
      <Head>
        <title>Ofis Malzemeleri - Ofis Teknik Kırtasiye</title>
        <meta
          name="description"
          content="Ofis Malzemeleri - Ofis Teknik Kırtasiye"
        />
        <meta
          name="keywords"
      ...
      <div className={styles.container}>
        <div className={styles.card}>
          <div className={styles.headerText}>Ofis Malzemeleri</div>
          <p>
            {" "}
